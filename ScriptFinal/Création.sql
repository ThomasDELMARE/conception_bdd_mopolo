...
CREATE TABLE EMPRUNT(
	...
	CONSTRAINT EMPRUNT_PK PRIMARY KEY (ADHID, EMPID_BIBLIOTHÉCAIRE, ISBN, STARTDATE),
	CONSTRAINT EMPRUNT_ADHERENT_FK FOREIGN KEY (ADHID) REFERENCES ADHERENT(ADHID) ON DELETE CASCADE,
	CONSTRAINT EMPRUNT_EMPLOYEE0_FK FOREIGN KEY (EMPID_BIBLIOTHÉCAIRE) REFERENCES EMPLOYEE(EMPID) ON DELETE CASCADE,
	CONSTRAINT EMPRUNT_BOOK1_FK FOREIGN KEY (ISBN) REFERENCES BOOK(ISBN) ON DELETE CASCADE
);
...
CREATE TABLE RÉALISE(
	...
	CONSTRAINT RÉALISE_BOOK_FK FOREIGN KEY (ISBN) REFERENCES BOOK(ISBN) ON DELETE CASCADE,
	CONSTRAINT RÉALISE_AUTHOR0_FK FOREIGN KEY (AUTID) REFERENCES AUTHOR(AUTID) ON DELETE CASCADE
);
