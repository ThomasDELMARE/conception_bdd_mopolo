...
CREATE TABLE Auteur(
	...
	CONSTRAINT Auteur_PK PRIMARY KEY (Nom,Prenom,Date_de_naissance)
);

------------------------------------------------------------
-- Table: Éditeur
------------------------------------------------------------
CREATE TABLE Éditeur(
	Nom        VARCHAR2 (32) NOT NULL  ,
	Telephone  NUMBER(10,0)   ,
	Email      VARCHAR2 (64)  ,
	Adresse    VARCHAR2 (256)  ,
	CONSTRAINT Éditeur_PK PRIMARY KEY (Nom)
);
...
CREATE TABLE Adherent(
	...
	Prenom             VARCHAR2 (32) NOT NULL  ,
	Date_de_naissance  DATE  NOT NULL  ,
	Telephone          NUMBER(10,0)  NOT NULL  ,
...
CREATE TABLE Ouvrage(
	...
	,CONSTRAINT Ouvrage_Éditeur0_FK FOREIGN KEY (Nom) REFERENCES Éditeur(Nom)
);
...
CREATE TABLE Emprunt(
	...
	CONSTRAINT Emprunt_PK PRIMARY KEY (ID,ID_Bibliothecaire,ISBN, Date_de_debut),
	CONSTRAINT CHK_BOOLEAN_Rendu CHECK (Rendu IN (0,1))

	,CONSTRAINT Emprunt_Adherent_FK FOREIGN KEY (ID) REFERENCES Adherent(ID)
...
CREATE TABLE Realise(
	...
	Prenom             VARCHAR2 (32) NOT NULL  ,
	Date_de_naissance  DATE  NOT NULL  ,
	CONSTRAINT Realise_PK PRIMARY KEY (ISBN,Nom,Prenom,Date_de_naissance)

	,CONSTRAINT Realise_Ouvrage_FK FOREIGN KEY (ISBN) REFERENCES Ouvrage(ISBN)
	,CONSTRAINT Realise_Auteur0_FK FOREIGN KEY (Nom,Prenom,Date_de_naissance) REFERENCES Auteur(Nom,Prenom,Date_de_naissance)
);
